...
Shader "LXM/HalfDiffuseFragmentShader"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				fixed3 diffuseColor = _DiffuseColor.rgb * _LightColor0.rgb * (dot(i.normal, lightDir) * 0.5 + 0.5); //漫反射光照模型公式,其中_DiffuseColor是自己在properties中设置好的。
